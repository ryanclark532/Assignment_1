...
public class Main {
    ...
    private static JFrame createSim = new JFrame();
    ...
    public static void main(String[] args) throws IOException {
        ...
        CreateSimPage cs = new CreateSimPage(createSim);
        cs.load();
    ...
    private static void car() {
        ...
        Car temp = new Car(60, test.xStart, test.yStart, true);
    ...
    private static void saveSim() throws IOException {
        ls.save();
    }

    private static void loadSim() throws IOException {
        ls.load();
    }
